...
function isKiss(words) {
  ...
  for (const word of wordsArr) if (word.length > wordsCount) return "Keep It Simple Stupid";
  return "Good work Joe!";
}

// Alternative
const isKiss = words => words.split(" ").some((e, _, a) => e.length > a.length) ? "Keep It Simple Stupid" : "Good work Joe!";