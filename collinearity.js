...
// arrow function and logical AND
const collinearity = (x1, y1, x2, y2) => (x1 === 0 && y1 === 0 && x2 === 0 && y2 === 0) ? true : !(x1 * y2 - x2 * y1);

// shorter because 0 is falsy
const collinearity = (x1, y1, x2, y2) => (!x1 && !y1 && !x2 && !y2) ? true : !(x1 * y2 - x2 * y1);

// actually we do not neeed a ternary here
const collinearity = (x1, y1, x2, y2) => (!x1 && !y1 && !x2 && !y2) || !(x1 * y2 - x2 * y1);
