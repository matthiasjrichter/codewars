...
function rakeGarden(garden) {
  ...
  return gardenArr.map((e) => (e !== "rock" ? "gravel" : e)).join(" ");
}

//RegExp arrow function
const rakeGarden = (garden) => garden.replace(/(?!rock\b)\b\w+/g, "gravel");

//test
rakeGarden("slug spider rock gravel gravel gravel gravel gravel gravel gravel"); // 'gravel gravel rock gravel gravel gravel gravel gravel gravel gravel'
