...
// spread and .some()
function gaslighting(shirtWord, yourWord, friendsLetters) {
    return [...shirtWord].some((e, i) => e !== yourWord[i] && (friendsLetters.includes(e) || friendsLetters.includes(yourWord[i])));
}

  // arrow function
const gaslighting = (shirtWord, yourWord, friendsLetters) => [...shirtWord].some((e, i) => e !== yourWord[i] && (friendsLetters.includes(e) || friendsLetters.includes(yourWord[i])));

//test
gaslighting("snack", "snake", "c"); //true
