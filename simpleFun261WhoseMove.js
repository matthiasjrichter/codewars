...
function whoseMove(lastPlayer, win) {
  if (win === true && lastPlayer === "white") return "white";
  else if (win === true && lastPlayer === "black") return "black";
  else if (win === false && lastPlayer === "white") return "black";
  else if (win === false && lastPlayer === "black") return "white";
}
