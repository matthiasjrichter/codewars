...
function conjugate(verb) {
    ...
    let result = {};
    if (verb.endsWith("ar")) result[verb] = [`${stem}o`, `${stem}as`, `${stem}a`, `${stem}amos`, `${stem}áis`, `${stem}an`];
    if (verb.endsWith("er")) result[verb] = [`${stem}o`, `${stem}es`, `${stem}e`, `${stem}emos`, `${stem}éis`, `${stem}en`];
    if (verb.endsWith("ir")) result[verb] = [`${stem}o`, `${stem}es`, `${stem}e`, `${stem}imos`, `${stem}ís`, `${stem}en`];
    
    return result;
}

console.log(conjugate("vivir")); // { vivir: ["vivo", "vives", "vive", "vivimos", "vivís", "viven"] }
